...
# Konfiguration
DATA_DIR = os.environ.get('DATA_DIR', '/config/alex_tennis_stringing')
DB_PATH = os.path.join(DATA_DIR, 'alex_tennis_stringing.db')
...
def create_bespannung():
    data = request.json
    print(f"Empfangene Daten: {data}")  # Debug-Log
...
@app.route('/gantt')
def gantt():
    return send_from_directory('static', 'gantt.html')
